...
class DemoApp:
    ...
    def save_intrinsics(self, intrinsics, width, height, depth_scale, filename):
        camera_properties = {
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device_name', type=str, help='specify an id of the camera in non-integer type.') 
    args = parser.parse_args()

    app = DemoApp()
    app.connect_to_device(dev_idx=0, dev_name=args.device_name)
